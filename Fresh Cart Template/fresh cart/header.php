        ...
        <div class="row w-100 align-items-center gx-lg-2 gx-0">
          ...
          <?php 
              ...
              ?>
                                ...
                                <a class="navbar-brand d-none d-lg-block" href="index.php"> <img src="./assets/images/logo/<?php echo $row['Logo'] ?>" alt=""
                              ></a>
    ...
    <div class="container px-0 px-md-3">
      <div class="dropdown me-3 d-none d-lg-block">
        ...
        <?php 
                                ...
                                ?>
          <li> <h6 class="text-primary ps-3"> <a href="productscard.php?p_cid=<?php echo $crow['p_cid'] ?>">    <?php echo $crow['Parent_Categor_Name'] ?></h6></a>
          <?php  }?>
        </ul>
      </div>
          ...
          <ul class="navbar-nav align-items-center ">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="index.php">Home 4 <span
            ...
            <li class="nav-item dropdown dropdown-fullwidth">
              ...
              <div class=" dropdown-menu pb-0">
                ...
                <div class="col-lg-3 col-6 mb-4 mb-lg-0">
                  <?php
                  $padairy="SELECT * FROM `parent_category` WHERE p_cid=1";
                  $resultpadairy = mysqli_query($conn,$padairy);

                  while($padrow = mysqli_fetch_array($resultpadairy)){

                  ?>
                    <h6 class="text-primary ps-3"> <a href="productscard.php?p_cid=<?php echo $padrow['p_cid'] ?>">    <?php echo $padrow['Parent_Categor_Name'] ?></h6></a>
                    <?php  }?>
                <?php 
                                $dairy= "SELECT * FROM `category` as c JOIN `parent_category`as p ON c.Parent_Category1 = p.p_cid WHERE c.Parent_Category1= 1";
                                $resultdairy = mysqli_query($conn,$dairy);

                                while($drow = mysqli_fetch_array($resultdairy)){

                               
                                ?>
                  

                    <a class="dropdown-item" href="shop-grid.php"><?php echo $drow['Name'] ?></a>
                   
                    <?php  }?>
                  </div>
                  <div class="col-lg-3 col-6 mb-4 mb-lg-0">
                  <?php
                  $padairy="SELECT * FROM `parent_category` WHERE p_cid=6";
                  $resultpadairy = mysqli_query($conn,$padairy);
                 ...
                 <h6 class="text-primary ps-3"> <a href="productscard.php?p_cid=<?php echo $padrow['p_cid'] ?>">    <?php echo $padrow['Parent_Categor_Name'] ?></h6></a>
                    <?php  }?>
                    <?php 
                                $dairy= "SELECT * FROM `category` as c JOIN `parent_category`as p ON c.Parent_Category1 = p.p_cid WHERE c.Parent_Category1= 6";
                                $resultdairy = mysqli_query($conn,$dairy);
                  ...
                  <?php
                  $padairy="SELECT * FROM `parent_category` WHERE p_cid=2";
                  $resultpadairy = mysqli_query($conn,$padairy);
                 ...
                 <h6 class="text-primary ps-3"> <a href="productscard.php?p_cid=<?php echo $padrow['p_cid'] ?>">    <?php echo $padrow['Parent_Categor_Name'] ?></h6></a>
                    <?php  }?>
                    <?php 
                                $dairy= "SELECT * FROM `category` as c JOIN `parent_category`as p ON c.Parent_Category1 = p.p_cid WHERE c.Parent_Category1= 2";
                                $resultdairy = mysqli_query($conn,$dairy);
          ...
          <ul class="navbar-nav ">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="">Home 4 <span
                      class="badge bg-light-info text-dark-info ms-1">New</span></a></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
