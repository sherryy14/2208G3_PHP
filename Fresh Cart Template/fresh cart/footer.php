          ...
          <div class="col-6">
            ...
            <ul class="nav flex-column">
              <?php
                 ...
                 $parent_category = "SELECT * FROM `category` ORDER BY cid DESC LIMIT 6  ";
...
<li class="nav-item mb-2"><a href="#!" class="nav-link"><?php echo $crow['Name']?></a></li>
...
<?php  }?>
      ...
      <div class="col-12 col-md-12 col-lg-8">
        <div class="row g-4">
          ...
          <div class="col-6 col-sm-6 col-md-3">
            <h6 class="mb-4">Parent Category</h6>
            <ul class="nav flex-column">
            <?php 
                                ...
                                ?>
          <li>  <h6 class=""><a class="dropdown-item" href="productscard.php?p_cid=<?php echo $crow['p_cid'] ?>">
          <?php echo $crow['Parent_Categor_Name'] ?></h6></a></li>
    ...
    <div class="border-top py-4">
      ...
      <?php 
                                ...
                                $footerResult = mysqli_query($conn,$footer);

                                while($frow = mysqli_fetch_array($footerResult)){

                               
                                ?>
        <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
          <ul class="list-inline mb-0">
            <li class="list-inline-item text-dark"><?php echo $frow['Title'] ?></li>
            <li class="list-inline-item">
              <a href="#!"><img src="./assets/images/payment/<?php echo $frow['Partner_Image1'] ?>" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="./assets/images/payment/<?php echo $frow['Partner_Image2'] ?>" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="./assets/images/payment/<?php echo $frow['Partner_Image3'] ?>" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="./assets/images/payment/<?php echo $frow['Partner_Image4'] ?>" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="./assets/images/payment/<?php echo $frow['Partner_Image5'] ?>" alt=""></a>
            </li>
          </ul>
        ...
        <?php  }?>
        <?php 
                                $footer_= "SELECT * FROM `footer`";
                                $footer_Result = mysqli_query($conn,$footer_);

                                while($fdrow = mysqli_fetch_array($footer_Result)){
        ...
        <div class="col-lg-7 mt-4 mt-md-0">
          <li class="list-inline-item mb-2 mb-md-0 text-dark"><?php echo $fdrow['Title2'] ?></li>
            <li class="list-inline-item ms-4">
              <a href="#!"> <img src="./assets/images/appbutton/<?php echo $fdrow['Partner_Image6'] ?>" alt=""
                  style="width: 140px;"></a></li>
            <li class="list-inline-item">
              <a href="#!"> <img src="./assets/images/appbutton/<?php echo $fdrow['Partner_Image7'] ?>" alt=""
                  style="width: 140px;"></a></li>
          </ul>
        </div>
        <?php  }?>
