            ...
            <div class="card h-100 card-lg">
              ...
              ?>
                      <tr>
                        ...
                        <td>
                          <a href="#!"> <img src="./assets/images/banner/<?php echo $brow['Banner_image'] ?>" alt=""
                        ...
                        <td><?php echo $brow['Span'] ?></td>
                        <td><?php echo $brow['Shop'] ?></td>
                        <td>
                        <div>
                        <a href="update_banner.php?id=<?php echo $brow['bid'];?>" class="btn btn-primary text-white">Edit</a>
                        <a href="delete_banner.php?id=<?php echo $brow['bid'];?>" class="btn btn-danger text-white">Delete</a>
                        </div>
