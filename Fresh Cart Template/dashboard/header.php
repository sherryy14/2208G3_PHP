            ...
            <nav class="navbar-vertical-nav d-none d-xl-block ">
              ...
              ?>
                 ...
                 <div class="px-4 py-5">
                                ...
                                <a href="index.php"> <img src="./assets/images/logo/<?php echo $row['Logo'] ?>" alt=""
                              ></a>
                              </div>
...
<?php }?>
                                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                                    <ul class="navbar-nav flex-column" id="sideNavbar">
                                        ...
                                        <li class="nav-item mt-6 mb-3">
                                            ...
                                            <a class="nav-link "  href="add_slider.php">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="nav-link-text"> Add Slider</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                            <a class="nav-link "  href="slider.php">
                                             ...
                                             <li class="nav-item ">
                                            <a class="nav-link "  href="parent_category.php">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-icon"> <i class="bi bi-cart"></i></span>
                                                    <span class="nav-link-text">Parent Categories</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                        ...
                                        <li class="nav-item ">
                                            <a class="nav-link " href="add_organic_coffee_banner.php">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-icon"> <i class="bi bi-list-task"></i></span>
                                                    <span class="nav-link-text">Add best sells banner</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                            <a class="nav-link " href="organic_coffe_banner.php">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-icon"> <i class="bi bi-list-task"></i></span>
                                                    <span class="nav-link-text"> Best sells banner</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                            <a class="nav-link " href="add_details.php">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-icon"> <i class="bi bi-list-task"></i></span>
                                                    <span class="nav-link-text">Add Details</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                        ...
                                        <li class="nav-item ">
                                            <a class="nav-link " href="add_bottom_footer.php">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-icon"> <i class="bi bi-list-task"></i></span>
                                                    <span class="nav-link-text"> Add footer</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item ">
