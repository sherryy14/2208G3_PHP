            ...
            <div class="card h-100 card-lg">
              ...
              ?>
                      <tr>
                        ...
                        <td>
                        <div>
                        <a href="update_blog.php?id=<?php echo $brow['bid'];?>" class="btn btn-primary text-white">Edit</a>
                        <a href="delete_blog.php?id=<?php echo $brow['bid'];?>" class="btn btn-danger text-white">Delete</a>
                        </div>
