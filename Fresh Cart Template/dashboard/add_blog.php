...
if(isset($_POST['add_blog'])){
    ...
    $blogs= "INSERT INTO `blog` ( `Blog_Image`, `Title`, `Description`, `Date`, `Time`) VALUES ('$Blog_Img', '$Title', '$Description', '$Date', '$Time')";
    $blogsresult = mysqli_query($conn, $blogs);
 ...
 <main class="page-content">
        ...
        <div class="row mb-8">
         ...
         <div class="row">
                ...
                <div class="card">
                   <div class="card-body">
                   <h4 class="mb-4 h5 mt-5">BLOGS</h4>
