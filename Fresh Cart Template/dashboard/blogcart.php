        ...
        <div class="row mb-8">
          <div class="col-md-12">
            ...
            <div class="d-md-flex justify-content-between align-items-center">
              ...
              <!-- button -->
              <div>
                <a href="add_blogcart.php" class="btn btn-primary">Add Blog</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card h-100 card-lg">
              ...
              ?>
                      <tr>
                        ...
                        <td>
                        <div>
                        <a href="update_blogcart.php?id=<?php echo $brow['bcid'];?>" class="btn btn-primary text-white">Edit</a>
                        <a href="delete_blogcart.php?id=<?php echo $brow['bcid'];?>" class="btn btn-danger text-white">Delete</a>
                        </div>
