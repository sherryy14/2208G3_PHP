...
if(isset($_POST['add_blog'])){
    ...
    $blogcart= "INSERT INTO `blog_cart` ( `Blog_Image`, `Title`, `Description`, `Date`, `Time`) VALUES ('$Blog_Img', '$Title', '$Description', '$Date', '$Time')";
    $blogcartresult = mysqli_query($conn, $blogcart);
 ...
 <main class="page-content">
        ...
        <div class="row mb-8">
         ...
         <div class="row">
                ...
                <div class="card">
                   <div class="card-body">
                   <h4 class="mb-4 h5 mt-5">BLOG CARDS</h4>
