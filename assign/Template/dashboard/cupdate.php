...
if(isset($_POST['update'])){
  ...
  $update = "UPDATE  `category` SET `cname` = '{$cname}', `cimage`= '{$image1}' WHERE `cid` = '{$hiddenId}'";
  ...
  <body>
          ...
          <form action="" method="post" class="d-flex justify-content-center flex-column align-items-center" enctype="multipart/form-data">
            <div class="card">
              <div class="card-body p-4">
                <h5 class="mb-4">Update  Form<?php echo $cid ?></h5>
    ...
    ?>
                ...
                <label for="input35" class="col-sm-3 col-form-label">Category Name</label>
                  <div class="col-sm-9">
                  <input name="cname" type="text" class="form-control" placeholder="Category Name" value='<?php echo $row['cname'];?>'>
                  </div>
                </div>
              
                <div class="row mb-3">
                  <label for="input39" class="col-sm-3 col-form-label">Category Image</label>
                  <div class="col-sm-9">
                  <input  type="file" name="cimage" value="<?php echo $row['cimage'] ?>" >
                  </div>
